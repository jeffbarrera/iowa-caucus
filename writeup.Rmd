...
_Comparison of different extrapolation techniques: model line in red, actual vote share in green._
...
Arguably running this test naively--that is, just testing it on 2008 and 2012 without any cross-validation--could lead to a type of overfitting, but we'd expect the size of improvement to be minimal.
